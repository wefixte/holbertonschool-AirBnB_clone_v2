<p align="center">
    <img [AirBnB clone - MySQL] src="https://github.com/wefixte/holbertonschool-AirBnB_clone_v2/blob/master/AirBnB_clone-Mysql.png">
</p>
...
* [cmd module](https://intranet.hbtn.io/rltoken/n2iuMmutfCZmeMqbeBnlaw)
* packages concept page
* [unittest module](https://intranet.hbtn.io/rltoken/nUpQTzwnNi_c8AIKoBdrmw)
* [args/kwargs](https://intranet.hbtn.io/rltoken/m8vYyTQi5-raOlUJJ9NItg)
* [SQLAlchemy tutorial](https://intranet.hbtn.io/rltoken/2DZHkwnlEmv4Iy7hufh3Xg)
* [How To Create a New User and Grant Permissions in MySQL](https://intranet.hbtn.io/rltoken/OpbgfN52Xc5Vrwug9jAb5A)
* [Python3 and environment variables](https://intranet.hbtn.io/rltoken/VHWw0H0LGwlpUBCI1qkPSQ)
* [SQLAlchemy](https://intranet.hbtn.io/rltoken/3rDo_Lb9DFRufb4Zh3JbdQ)
* [MySQL 8.0 SQL Statement Syntax](https://intranet.hbtn.io/rltoken/9dZyqKjKVADhWytWrK8F6A)
* [AirBnB clone - ORM](https://intranet.hbtn.io/rltoken/ZsjgMgJW7i6QXz6LlRP78Q)
...
![hbnb_step2.](https://github.com/wefixte/holbertonschool-AirBnB_clone_v2/blob/master/hbnb_step2.png)
...
Score: 19.44% (Checks completed: 19.44%)
...
Some tests won’t be relevant for some type of storage, please skip them by using the skipIf feature [of the Unittest module - 26.3.6. Skipping tests and expected failures.](https://intranet.hbtn.io/rltoken/AldbsIVZtz1aJsSde2fVTg) Of course, the number of tests must be higher than the current number of tests, so if you decide to skip a test, you should write a new test!
...
![image](https://github.com/wefixte/holbertonschool-AirBnB_clone_v2/blob/master/daaef631636b40e0a279a8f240703e065f9d3481.jpg)
